...
class ScenarioGenerator(object):
    ...
    def cutFormList(self,inputList):      
        ...
        Cuts whole scenario into single quests
    ...
    def fillQuest(self, xmlData):
        ...
        item = i.next() #iterate twice in order to skip two first 
        item = i.next()
    ...
    def xmlFinish(self):
        '''
        Writes parsed data into a .xml file
        '''
    ...
    def addMultiChild(self, prefix, wrapper,section):
        '''
        Adds children in a certain section
        '''
    ...
    def addComplexChild(self, indentList, wrapper):
        '''
        Adds a child which can have other children
        '''
    ...
    def addIndentation(self, wrapper):
        '''
        Adds indentation to main tree in quest
        '''
    ...
    def addChild(self, prefix, wrapper):
         '''
         Adds children to a tree defined by a prefix
         '''
    ...
    def createSingleTask(self, prefix, wrapper): 
        '''
        Returns one task which can be appended to tree in other method
        '''
        temp = wrapper.item[0]                  
